...
public final class ErrorMessageConstant {
    ...
    public static final String BLANK_INPUT =
            "빈 문자열이 입력되었습니다.";
    public static final String NOT_ONLY_DIGIT =
            "숫자를 제외한 문자가 포함되어 있습니다.";
    public static final String NOT_DIGITS_AND_COMMA_ONLY =
            "숫자와 쉼표(,)를 제외한 문자가 포함되어 있습니다.";

    public static final String INVALID_PURCHASE_AMOUNT_RANGE =
            String.format(
    ...
    public static final String DUPLICATED_LOTTO_NUMBER =
            "로또 번호는 중복될 수 없습니다.";

    public static final String DUPLICATED_WINNING_AND_BONUS_NUMBER =
